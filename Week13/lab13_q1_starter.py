...
def count_by_field(findings, field):
    """Loop through findings and count how many times each unique
    value of findings[field] appears.
    Returns a dictionary, e.g. {"HIGH": 4, "MEDIUM": 3, "LOW": 5}"""
    counts = {}
...
def top_subdomains(findings, n):
    """Count findings per subdomain, sort by count descending,
    and return the top n as a list of (subdomain, count) tuples."""
